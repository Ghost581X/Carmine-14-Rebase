...
public sealed class DockTest : ContentUnitTest
{
    ...
    public async Task TestDockingConfig(Vector2 dock1Pos, Vector2 dock2Pos, Angle dock1Angle, Angle dock2Angle, bool result)
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            var dock1 = entManager.SpawnEntity("BaseDock", new EntityCoordinates(grid1Ent, dock1Pos)); //Carmine: renamed dock
            ...
            var dock2 = entManager.SpawnEntity("BaseDock", new EntityCoordinates(grid2Ent, dock2Pos)); //Carmine: renamed dock
    ...
    public async Task TestPlanetDock()
    {
        ...
        await server.WaitAssertion(() =>
        {
            ...
            var airlockEnt = entManager.SpawnEntity("BaseDock", new EntityCoordinates(map.MapUid, Vector2.One / 2f)); //Carmine: renamed dock
