...
#nullable disable //just trust me bro

// taken from https://github.com/oberbichler/earcut.net
// CARMINE: used for triangulating biome shapes in SpaceBiomeSystem, and in ShuttleMapControl.xaml.cs for the same purpose.
// dummy explanation for what this does:
// u have a set of points defining a polygon, ordered clockwise. because of how this engine works, you can display points, lines, or sets of triangles
// we triangulate the polygon (divide it into triangles) by using this algorithm
// and it outputs the INDICES of the points you gave it. so for example
// if you give it 4 points, and those points form a square, it might output "0, 1, 2, 0, 2, 3" which means "draw a triangle using points 0, 1, and 2, then draw another triangle using points 0, 2, and 3"
namespace Content.Client.EarcutNet
{
    public class Earcut
    {
