...
/// This basically got changed entirely and you should assume this entire file is changed, compared to upstream. .2 | 2026
/// </summary>
public sealed partial class ContentAudioSystem
{
    ...
    private void InitializeAmbientMusic()
    {
        ...
        SubscribeLocalEvent<CombatModeToggledEvent>(OnCombatModeToggle); //carmine edit: Combatmodetoggledevent cuz we have combatmode button instead of action
    ...
    private void OnCombatModeToggle(CombatModeToggledEvent ev) //carmine edit: Combatmodetoggledevent cuz we have combatmode button instead of action
    {
