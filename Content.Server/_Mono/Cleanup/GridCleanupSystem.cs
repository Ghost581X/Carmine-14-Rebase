...
public sealed class GridCleanupSystem : BaseCleanupSystem<MapGridComponent>
{
    ...
    //private EntityQuery<BatteryComponent> _batteryQuery; //carmine: we dont care about powered apcs
    ...
    public override void Initialize()
    {
        ...
        //_batteryQuery = GetEntityQuery<BatteryComponent>(); //carmine: we dont care about powered apcs
    ...
    protected override bool ShouldEntityCleanup(EntityUid uid)
    {
        ...
        var tiles = body.FixturesMass / SharedShuttleSystem.TileDensityMultiplier; //carmine: tilemassmultiplier moved to shared and renamed tiledensitymultiplier
        ...
        if (HasComp<MapComponent>(uid) // if we're a planetmap ignore
            ...
            //|| !state.IgnorePowered && HasPoweredAPC((uid, xform)) // don't delete if it has powered APCs //carmine: we dont care about powered apcs
    ...
    //carmine: we dont care about powered apcs
